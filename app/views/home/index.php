        ...
        <article class='post hentry'>
            <a href="/kit_club/index.php?url=news/detail/<?=$key['id']?>" >
                <div class='img-thumbnail'>
                    ...
                    <img src="public/img_news/thumbnail/<?php echo $key['tags']."/".$key['images'] ?>">
                </div>
...
<?php
                                        ...
                                        <div class="example">
                                            ...
                                            ?>
                                                    ...
                                                    <?php if($param>1)
                                                    echo
                                                    "<li ><a href='/kit_club/index.php?url=home/index/".($param-1)."' class=' wow bounceInLeft' data-wow-delay='0.2s'>"."&laquo;"."</a></li>" ;?>
                                                     <?php if($param>1)
                                                    echo" <li><a   href='/kit_club/index.php?url=home/index/".($param-1)."' class=' wow bounceInLeft' data-wow-delay='0.1s'>". ($param-1)." </a></li>";?>
                                                     <li><a  style="background-color:#F0F0F0" href="/kit_club/index.php?url=home/index/<?=$param?>" class=" wow bounceInLeft" data-wow-delay="0.1s"><?=$param?></a></li>
                                                    <li><a href="/kit_club/index.php?url=home/index/<?=$param+1?>" class=" wow bounceInLeft" data-wow-delay="0.1s"><?=$param+1?></a></li>
